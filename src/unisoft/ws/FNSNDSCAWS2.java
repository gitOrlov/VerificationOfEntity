 ...
 * 
 */
@WebServiceClient(name = "FNSNDSCAWS2", targetNamespace = "http://ws.unisoft", wsdlLocation = "http://npchk.nalog.ru:80/FNSNDSCAWS_2?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://npchk.nalog.ru:80/FNSNDSCAWS_2?wsdl");
